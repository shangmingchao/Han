 ...
 * mockedUserDTO
 */
val mockedUserDTO = UserDTO(MOCKED_USER_ID, MOCKED_USER_LOGIN, MOCKED_USER_NAME, MOCKED_USER_PUBLIC_REPOS)

/**
 * mockedUserPO
 */
val mockedUserPO = UserPO(MOCKED_USER_ID, MOCKED_USER_LOGIN, MOCKED_USER_NAME, MOCKED_USER_PUBLIC_REPOS)
